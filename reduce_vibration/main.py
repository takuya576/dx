...
if config.generated:
    ...
    train_dir = os.path.join(
        os.path.join(os.path.expanduser("~/dx"), "generated_data/"),
        which_data,
        train_data_name,
    )
else:
    ...
    train_dir = os.path.join(
        os.path.join(os.path.expanduser("~/dx"), "data/"), which_data, train_data_name
    )

test_dir = os.path.join(
    os.path.join(os.path.expanduser("~/dx"), "data"), which_data, config.test_data
)
print(train_dir)
